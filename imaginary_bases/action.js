...
['base 2i with digits 0, 1, i, and -1+i color by 1st','@resbertaninon6860'],
['base 1+2ω with digits 0, -1+ω, and 2-ω color by lead','@4.5tc'],
...
['base -3ω with digits 0, 5ω, 5, -5ω, -5, -5-5ω, 5+5ω, -2-ω, 1+2ω, 2+ω, -1-2ω, 1-ω, -1+ω, 2, 2ω, 2+2ω, -2, -2ω, and -2-2ω color by 1st','@user-tyup252'],
['base 2ω with digits 0, -1, -1+2ω, and -1-ω color by 1st','@a71_special'],
['base 3 with digits 0, 1, 1+i, -1+2i, -1, -1+i, 1+2i, and 2i color by 1st','@viscovaldirio8224'],
['base -3+ω with digits 0, 1, 1+ω, ω, -1, 1-ω, -1-2ω, -ω, 1+2ω, 2+ω, -2-ω, -1-ω, and -1+ω color by 2nd',''],
['base -1+ω with digits 0, 1, and 2 color by 2nd','@Franek-n1i'],
['base -2 with digits 0, 1, ω, and -1-ω','@Amipotsophspond'],
['base 1+2ω with digits 0, 1, and 3+5ω','@kinoseidon'],
...
['base 4 with digits 0, 4+3ω, 1-ω, 1, -3+ω, 1+2ω, -2-ω, -1-ω, -2+ω, ω, 3+2ω, -1-4ω, -1-3ω, 2+2ω, -2, and -2ω','@TheAgamemnon911'],
['base 5+10i with digits 0, 1+2i, 2i, i, 3i, 4i, 2, 2+i, 2+2i, 2+3i, 2+4i, 4, 4+i, 4+2i, 4+3i, 4+4i, 6+4i, 5+4i, 5+2i, 6+2i, 5, 6, 8+4i, 8+3i, 8+2i, 8+i, 8, 9, 10, 12+3i, 12+4i, 12+i, 16+4i, 12+2i, 12, 13, 14, 16+i, 18+2i, 16, 18+3i, 18, 17+4i, 16+2i, 18+i, 17, 18+4i, and 16+3i color by 2nd','@4.5tc'],
...
['base -3+ω with digits 0, 2ω, -2-2ω, -2, 2+2ω, 2, -2ω, 1+2ω, 2+ω, 1-ω, -1-2ω, -2-ω, and -1+ω','@beta_electron'],
...
['base 2 with digits 0, 1, and 1+ω color by 1st','@RodrigoParaNiños'],
['base 1+6ω with digits 0, 1, ω, -1-ω, -1+ω, -1-2ω, 2+ω, -1-3ω, 3+2ω, -2+ω, 3+3ω, -3, -3ω, -3-ω, 1-2ω, and 2+3ω color by 1st','@supu8599'],
['base -2-2ω with digits 0, 1+ω, -ω, and -1 color by 2nd','@kshamasharma4725'],
['base 3 with digits 0, 2, 2+ω, 1-ω, -ω, and 1+ω','@StephenjamesRidge'],
['base 3-2i with digits 0, 2+2i, -1+i, 1+i, 4i, -2+2i, 2i, -1+3i, and 1+3i','@ViscoValdirio'],
...
['base -6-ω with digits 0, 2+3ω, -4-4ω, 4+3ω, 4ω, -1+ω, 1-ω, -2-ω, 1+2ω, -4-ω, -3-ω, 1+4ω, 3+2ω, -2+ω, 4, -1+3ω, 4+ω, 3-ω, -1-2ω, -4, -3-4ω, 3+4ω, 1-2ω, -1-3ω, -3+ω, 2+ω, -1-4ω, 1-3ω, 4+4ω, -4ω, and -4-3ω','a family of squirrels'],
['base 2+i with digits 0, 1, 2, -1, and 2+2i color by 2nd','@JHF563'],
['base -2+3ω with digits 0, -ω, -1-ω, ω, -3-ω, 2+2ω, -1+2ω, -2ω, 1, 1-2ω, 3+ω, -2-3ω, -2, -3-3ω, 2+3ω, 3ω, 1+ω, -1, and 3 color by 2nd',''],
['base 4 with digits 0, 2+2ω, ω, 1+ω, 3+ω, 1, -1-ω, -ω, 1-ω, -2ω, -1, -2-ω, 2, 1+2ω, -2+ω, and -1-2ω','@Slaydrik'],
['base -1+2i with digits 0, 1, i, -1, and -i',''],
['base 2+2ω with digits 0, -ω, 1, and -3ω','@a71_special'],
['base 2 with digits 0, 1, 3+ω, and 2+3ω color by 5th','@not_threadbox'],
['base -2+3ω with digits 0, 1, ω, -5-3ω, 2+5ω, -1-ω, 3-2ω, 4+3ω, 3+ω, 2ω, -2-3ω, 3+2ω, -1+2ω, 2, -2+ω, -1-3ω, -2-2ω, -1-4ω, and -3+ω color by 2nd',''],
['base 10+10i with digits 0, 2, -2, 3+i, 2+2i, -1-i, 2-2i, -3+i, 2i, -2-2i, 1+i, -1+3i, -2+2i, -1+i, -2i, 1+3i, 1-i, -3-i, -1-3i, 1-3i, 3-i, 4i, -4, -4i, 4, -i, i, -1, 1, -3i, 3i, 3, and -3 color by lead','@KesseliYT-tauloud2'],
['base -4+i with digits 0, 2, -2, 4+3i, 2+2i, -1-i, 2-2i, -4-3i, 2i, -2-2i, 1+i, -3+4i, -2+2i, -1+i, -2i, 3-4i, and 1-i color by lead',''],
['base 5+7i with digits 0, 1, i, -1, -i, 2+3i, -2-3i, -3+2i, 2+i, -2-i, 1-2i, 6+2i, -1+2i, -1-i, -1+i, -2i, 1-i, 1+i, 2i, 1+2i, 2, 2-i, 2-2i, -2+i, 3-i, -2, -2+2i, -3, 3i, 3+i, -1+3i, -2+3i, 3, 1-3i, -3+i, -1-2i, 2+2i, -3i, 1+3i, 2-3i, -3-i, 3+2i, -1-3i, -2-2i, -4+i, -3+3i, 3+3i, -4, 4i, -3-2i, -4+2i, 5+3i, -4-i, 4+3i, 6, -5-2i, -4-2i, 1+4i, -1+4i, 5, 5-i, -5+i, 4, 4+i, 6+3i, 5+i, 4+2i, 5+2i, 4-i, 3-2i, -5, -5-i, 2+4i, and 6+i color by 1st','@khaledk13'],
